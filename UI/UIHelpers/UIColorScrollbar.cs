...
public class UIColorScrollbar : UIElement
{
    public Color borderAndBackgroundColor = Color.White;
    ...
    protected override void DrawSelf(SpriteBatch spriteBatch)
    {
        ...
        DrawBar(spriteBatch, _texture.Value, dimensions.ToRectangle(), borderAndBackgroundColor);
